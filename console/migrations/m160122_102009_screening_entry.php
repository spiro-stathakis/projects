    ...
    public function up()
    {
        ...
        $this->createTable(
                ...
                [
                    ...
                    'screening_form_title'=>$this->string(4096)->notNull(), 
                    'screening_form_description'=>$this->string(4096),
                    'resource_title'=>$this->string(4096)->notNull()->defaultValue('The scanner'), 
