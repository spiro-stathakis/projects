...
class m160108_144951_ref_boolean extends XMigration
{
    ...
    public function up()
    {
        ...
        $this->init(); 
            ...
            $this->insert($this->tableName,['code'=>'true','name'=>'True','description'=>'Yes', 'sort_order'=>100,'status_id'=>2,'created_at'=>time(),'created_by'=>1]);
            $this->insert($this->tableName,['code'=>'false','name'=>'False','description'=>'No', 'sort_order'=>100,'status_id'=>2,'created_at'=>time(),'created_by'=>1 ]);
